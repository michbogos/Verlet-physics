...
3d-array: 3d-array.cpp
	g++ 3d-array.cpp -lraylib -lGL -lm -lpthread -ldl -lrt -lX11 -o verlet -Ofast -march=native -mtune=native -funroll-loops -fno-signed-zeros -fno-trapping-math -fopenmp -D_GLIBCXX_PARALLEL
